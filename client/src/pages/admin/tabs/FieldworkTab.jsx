...
export default function FieldworkTab() {
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      {showAddForm && (
        <form onSubmit={addFieldwork} className="admin-welcome-panel" style={{ width: '100%', marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '16px', background: 'var(--ink-2)', border: '1px solid var(--line)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            ...
            <input
              type="text"
              value={locationMeta}
              onChange={(e) => setLocationMeta(e.target.value)}
